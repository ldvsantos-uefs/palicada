...
![Figura 4 -- Estrutura e dimensão das paliçadas instaladas](media/artigo/montagem.png){width="6.5in"}
...
![Figura 5 -- Etapas de construção das paliçadas -- (a) Coleta de toras de bambu; (b) corte das toras; (c) coleta dos dados morfométricos das ravinas; (d) início de construção da paliçada; (e) amarrio das toras; (f) paliçadas prontas.](media/artigo/Fig_7v2.png){width="6.5in"}
...
## 2.8 Simulação espacial sob limiares
